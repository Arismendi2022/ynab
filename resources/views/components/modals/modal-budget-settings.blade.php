...
<div id="ember146" class="modal-overlay active modal-fresh mod-skinny modal-budget-settings">
	<div class="modal" role="dialog" aria-modal="true" style="left: 720px; top: 85px;">
